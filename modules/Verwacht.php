...
*/
	$fw = fetchFilmsstatus($pdo, "Verwacht"); // fw = fetchVerwacht. Functies.php lijn 144. Functie die de status: verwacht uit de database filterd met de titel, beschrijving, duur, genre, leeftijd en type.
/*
